<template lang="html">
  <div class="container">
    <TopBar title="保险产品详情"></TopBar>
    <TruckInfo></TruckInfo>
    <BankModel class="productInfo" imgSrc="http://frontendsvn.360che.com/icon-project/wap/m/detail/ZhpPreview/BOC.png" bankName="招商银行车险通" bankType="闪电赔付"></BankModel>
